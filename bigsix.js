...
Wheel: [ "flag","1","2","1","2","5","2","1","2","1","10","2","5","1","2","1","20","1","5","1","2","1","5","1","2","1","joker",
"1","5","1","2","1","10","1","2","1","5","1","2","1","20","1","2","1","2","1","5","1","10","1","2","1" ],
Bets: {"1":1,"2":2,"5":5,"10":10,"20":20,"flag":40,"joker":40},
PlayedBets: [],
spun: [],

Spin: function() {
		var spin = Math.floor(Math.random()*52)+1;
		spun=[spin,exports.SpinHash(spin)];
		return spun;
	},
...
PlaceBet: function(room,secret,bet,amount,callback) {
